-- adjustSoXEffectNamesInSelectedTracks -- changes descriptions of SoX
--                                         effects in effects lists
--                                         of selected tracks
--
-- by Dr. TT, 2023
...
local _programName = "adjustSoXEffectNamesInSelectedTracks"
...
function main ()
    ...
    local trackList = project:selectedTrackList()
